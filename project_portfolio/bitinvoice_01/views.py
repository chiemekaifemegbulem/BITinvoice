...
def index(request):
    context = {}
    return render(request, 'bitinvoice_01/index.html', context)
...
def login(request):
    ...
    if request.method == 'GET':
        form = UserLoginForm()
        context['form'] = form
        return render(request, 'bitinvoice_01/login.html', context)
...
def dashboard(request):
    ...
    return render(request, 'bitinvoice_01/dashboard.html', context)
...
def invoices(request):
    ...
    return render(request, 'bitinvoice_01/invoices.html', context)
...
def products(request):
    ...
    return render(request, 'bitinvoice_01/products.html', context)
...
def clients(request):
    ...
    if request.method == 'GET':
        form = ClientForm()
        context['form'] = form
        return render(request, 'bitinvoice_01/clients.html', context)
...
def createBuildInvoice(request, slug):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'bitinvoice_01/create-invoice.html', context)
...
def viewPDFInvoice(request, slug):
    ...
    #Get Client Settings
    p_settings = Settings.objects.get(clientName='BITInvoice')
    ...
    return render(request, 'bitinvoice_01/invoice-template.html', context)
...
def viewDocumentInvoice(request, slug):
    ...
    template = get_template('bitinvoice_01/pdf-template.html')
...
def companySettings(request):
    company = Settings.objects.get(clientName='BITInvoice')
    context = {'company': company}
    return render(request, 'bitinvoice_01/company-settings.html', context)
